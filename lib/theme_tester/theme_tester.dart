...
import 'package:innowatt/theme_tester/chat_screen.dart';
  ...
  Widget createScreenFor(
    ...
    bool showNavBarExample,
      ...
      switch (screenSelected) {
        ...
        ScreenSelected.chat => const ChatScreen(),
      };

  PreferredSizeWidget createAppBar() {
    return AppBar(title: const Text('Theme Tester'));
  }
